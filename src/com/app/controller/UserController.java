...
public class UserController {
	...
	public String saveUser(@ModelAttribute("user") User user, ModelMap map) {
		...
		commonUtil.sendEmail(user.getUserEmail(),
				"Registered as User to VDM...", text);
		map.addAttribute("msg",
				"Registered and mail sent .. id is:" + user.getUserId());
		return "RegUser";
	...
	public String doLoginUser(@RequestParam("un") String un,
